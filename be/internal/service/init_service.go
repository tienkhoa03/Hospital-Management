...
import (
	...
	"BE_Hospital_Management/internal/service/billing"
	"BE_Hospital_Management/internal/service/patient_management"
	"BE_Hospital_Management/internal/service/staff_management"
...
type Service struct {
	...
	PatientManagement patientmanagement.PatientManagementService
...
func NewService(repos *repository.Repository) *Service {
	return &Service{
		...
		PatientManagement: patientmanagement.NewPatientManagementService(repos.User, repos.UserRole, repos.Doctor, repos.Manager, repos.Nurse, repos.Staff, repos.Patient,
			repos.StaffRole, repos.Task, repos.Appointment, repos.MedicalRecord, repos.Prescription, repos.Bill, repos.BillItem),
		Billing: billing.NewBillingService(repos.User, repos.UserRole, repos.Doctor, repos.Manager, repos.Nurse, repos.Staff, repos.Patient,
			repos.StaffRole, repos.Task, repos.Appointment, repos.MedicalRecord, repos.Prescription, repos.Bill, repos.BillItem),
	}
}
