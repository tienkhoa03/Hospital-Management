...
func NewService(repos *repository.Repository) *Service {
	return &Service{
		...
		PatientManagement: patientmanagement.NewPatientManagementService(repos.User, repos.UserRole, repos.Doctor, repos.Manager, repos.Nurse, repos.Staff, repos.Patient, repos.StaffRole, repos.Task, repos.Appointment, repos.MedicalRecord, repos.Prescription, repos.Bill, repos.BillItem),
	}
}
